...
class DatabaseSeeder extends Seeder
{
    ...
    private array $foodCategories = [
        ['fruits'],                                // Delicious Crunch Apples
        ['fruits'],                                // Tropical Delight Bananas
        ['fruits'],                                // Zesty Citrus Oranges
        ['dairy'],                                 // Creamy Dairy Milk
        ['eggs'],                                  // Farm-Fresh Eggs
        ['breads'],                                // Artisanal Baker's Bread
        ['meat', 'chicken'],                       // Tender & Tasty Chicken
        ['meat', 'beef'],                          // Premium Choice Beef
        ...
        // Meats
        ['meat', 'pork'],                                // Tender Pork Chops
        ['meat', 'beef'],                                // Flavorful Ground Beef
        ['meat', 'chicken'],                             // Juicy Grilled Chicken Breasts
        ['meat', 'pork'],                                 // Premium Smoked Bacon
        ['meat', 'lamb'],                                 // Succulent Lamb Chops
        ['meat', 'poultry'],                              // Delicious Turkey Sausages
        ['meat', 'ribs'],                                 // Savory BBQ Ribs
        ['snacks', 'jerky'],                              // Tasty Beef Jerky
        ['meat', 'poultry'],                              // Gourmet Duck Breast
        ['meat', 'veal'],                                 // Tender Veal Cutlets

        ['snacks'],                                       // Crunchy Potato Chips
    ...
    private array $drinksCategories = [
        ...
        ['alcohol', 'whiskey'],
        ['alcohol'],
        ['alcohol', 'beer', 'refreshing', 'craft'],
        ['alcohol', 'vodka', 'premium'],
        ['alcohol', 'rum', 'aged', 'spice'],
        ['alcohol', 'white wine'],
        ['alcohol', 'gin', 'craft'],
        ['alcohol', 'tequila', 'agave', 'rich'],
        ['alcohol', 'craft beer', 'flavorful'],
        ['alcohol', 'sake', 'soothing', 'traditional'],
    ...
    private array $households = [
        ...
        'Efficient Slow Cooker from SimmerSavor',
        ...
        'Whitening Toothpaste from PearlWhite',
        'Nourishing Hand Cream from SoftGlow',
        'Soothing Body Wash from ZenRelax',
    
        // Medicine
        'Pain Relief Cream from SootheAway',
        'Children\'s Cold and Flu Syrup from SniffleStop',
        'Allergy Relief Tablets from ClearBreathe',
        'Digestive Health Probiotics from GutBalance',
        'Headache Relief Gel Caps from HeadEase',
        'Sleep Aid Melatonin Tablets from SweetDreams',
        'Antacid Chewable Tablets from TummyEase',
        'Multivitamin Gummies from VitaBoost',
        'Cough Suppressant Lozenges from SootheCough',
        'First Aid Kit Essentials from CareGuard',
    ...
    private array $householdCategories = [
        ...
        ['kitchen', 'slow cooker', 'efficient'],
        ['kitchen', 'air fryer', 'multi-function'],
        ['kitchen', 'blender', 'powerful'],
        ['kitchen', 'rice cooker', 'convenient'],
        ...
        ['personal care', 'shampoo and conditioner set', 'refreshing'],
        ...
        // Medicine
        ['medicine', 'pain relief cream', 'soothing'],
        ['medicine', 'cold and flu syrup', 'children\'s'],
        ['medicine', 'allergy relief tablets', 'relief'],
        ['medicine', 'digestive health probiotics', 'health'],
        ['medicine', 'headache relief gel caps', 'headache'],
        ['medicine', 'sleep aid tablets', 'sleep'],
        ['medicine', 'antacid chewable tablets', 'antacid'],
        ['medicine', 'multivitamin gummies', 'multivitamin'],
        ['medicine', 'cough suppressant lozenges', 'cough'],
        ['medicine', 'first aid kit essentials', 'first aid'],
    ...
    protected array $uniqueFoodCategories = [
    ...
    protected array $uniqueDrinksCategories = [
    ...
    protected array $uniqueHouseholdCategories = [
        ...
        'refreshing', 'face mask', 'hydrating', 'baby wipes', 'fragrance-free',
    ...
    public function run()
    {
        ...
        foreach($this->households as $index => $household)
        {
            ...
            $product = Product::factory()->create([
                ...
                'meta_type' => strtolower($household[0]),
