<x-layout>
    ...
    <x-container class="mb-10">
        <ul class="flex items-center my-3 px-3 py-3 text-sm">
            ...
            <li class="flex items-center ml-2 gap-x-1">
                <a href="{{ route('vendor.login') }}" class="{{ request()->routeIs('vendor.login') ? 'text-blue-600 dark:text-blue-300' : 'text-gray-700 dark:text-gray-300' }} hover:text-blue-600 dark:hover:text-blue-500">Vendor Login</a>
            </li>
        </ul>
    </x-container>
